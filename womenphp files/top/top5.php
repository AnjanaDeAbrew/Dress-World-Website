...
</header><form action="top5.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Top/201349156-1-yellow.jfif"></td>
		      <td><p class="one">Monki organic cotton flannel check shirt in yellow</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 3800</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Yellow</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Monki organic cotton flannel check shirt in yellow";
				 $price=3800;
				 $color="Yellow";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
