...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Top/324333-white.jfif"></td>
		      <td><p class="one">Ever New oversized bow babydoll top in white</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 2600</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Porcelain</p></td>
	        </tr>
		    <tr>								
...
<?php
			 ...
			 {
				 $proname="Ever New oversized bow babydoll top in white";
				 $price=2600;
				 $color="Porcelain";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
