...
</header><form action="top6.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Top/201570453-1-brown.jfif"></td>
		      <td><p class="one">Stradivarius textured stretch 90's shirt in chocolate</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Stradivarius textured stretch 90's shirt in chocolate";
				 $price=2900;
				 $color="Brown";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
