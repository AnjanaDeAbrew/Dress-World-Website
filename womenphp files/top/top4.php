...
</header><form action="top4.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Top/201025219-1-green.jfif"></td>
		      <td><p class="one">Mango blouse with collar in sage green</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Mango blouse with collar in sage green";
				 $price=4500;
				 $color="Green";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
