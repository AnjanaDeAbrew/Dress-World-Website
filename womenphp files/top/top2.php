...
</header><form action="top2.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Top/24204962-1-peach.jfif"></td>
		      <td><p class="one">Public Desire racer neck bodysuit in peach - part of a set</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 3200</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Peach</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Public Desire racer neck bodysuit in peach - part of a set";
				 $price=3200;
				 $color="Peach";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
