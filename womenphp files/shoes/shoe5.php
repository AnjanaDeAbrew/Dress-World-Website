...
</header><form action="shoe5.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Shoe/200523273-1-white.jfif"></td>
		      <td><p class="one">Converse Chuck Taylor All Star Move Hi sneakers in white</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Converse Chuck Taylor All Star Move Hi sneakers in white";
				 $price=7500;
				 $color="White";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
