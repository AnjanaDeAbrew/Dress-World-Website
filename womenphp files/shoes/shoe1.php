...
</header><form action="shoe1.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Shoe/21942206-1-blush.jfif"></td>
		      <td><p class="one">Wide Fit Placid high block heels in beige</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 4500</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Blush</p></td>
	        </tr>
		    <tr>								
...
<?php
			 ...
			 {
				 $proname="Wide Fit Placid high block heels in beige";
				 $price=4500;
				 $color="Blush";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
