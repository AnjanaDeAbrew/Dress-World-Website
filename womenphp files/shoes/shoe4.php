...
</header><form action="shoe4.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Shoe/200473964-1-brown.jfif"></td>
		      <td><p class="one">Nike Court Vision Alta Leather platform sneakers in light cognac</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 7500</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Nike Court Vision Alta Leather platform sneakers in light cognac";
				 $price=7500;
				 $color="Brown";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
