...
</header><form action="shoe6.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Shoe/201315072-1-brownpatent.jfif"></td>
		      <td><p class="one">Challenge chunky high-heeled knee boots in brown patent</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 6400</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Brown patent</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Challenge chunky high-heeled knee boots in brown patent";
				 $price=6400;
				 $color="Brown patent";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
