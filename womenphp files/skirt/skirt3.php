...
</header><form action="skirt3.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Skirt/200519769-1-ivory.jfif"></td>
		      <td><p class="one">Miss Selfridge Petite ruffle mini skirt in spot</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Miss Selfridge Petite ruffle mini skirt in spot";
				 $price=2000;
				 $color="Ivory";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
