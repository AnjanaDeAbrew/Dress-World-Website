...
</header><form action="skirt2.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Skirt/200519246-1-blue.jfif"></td>
		      <td><p class="one">Vesper tube midi skirt in cobalt - part of a set</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 6000</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Blue</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Vesper tube midi skirt in cobalt - part of a set";
				 $price=6000;
				 $color="Blue";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
