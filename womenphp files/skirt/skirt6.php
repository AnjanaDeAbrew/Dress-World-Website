...
</header><form action="skirt6.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Skirt/201292329-1-beige.jfif"></td>
		      <td><p class="one">Puma Classics tennis skirt in beige</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 3000</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Beige</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Puma Classics tennis skirt in beige";
				 $price=3000;
				 $color="Beige";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
