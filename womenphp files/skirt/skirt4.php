...
</header><form action="skirt4.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Skirt/200815693-1-multi.jfif"></td>
		      <td><p class="one">Fishtail maxi skirt in spliced floral print</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 2500</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Multi</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Fishtail maxi skirt in spliced floral print";
				 $price=2500;
				 $color="Multi";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
