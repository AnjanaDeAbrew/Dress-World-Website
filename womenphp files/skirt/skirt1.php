...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
		<ul class="nav-area">
		<li><a href="../skirt.php"><button class="btn2"><i class="fa fa-angle-left"></i> Previous </button></a></li>	
...
</header><form action="skirt1.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Skirt/23429166-1-stone.jfif"></td>
		      <td><p class="one">Ever New tie belt utility mini skirt with pockets in stone</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 3000</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Stone</p></td>
	        </tr>
		    <tr>								
...
<?php
			 ...
			 {
				 $proname="Ever New tie belt utility mini skirt with pockets in stone";
				 $price=3000;
				 $color="Stone";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
