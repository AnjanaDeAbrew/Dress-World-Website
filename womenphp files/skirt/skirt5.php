...
</header><form action="skirt5.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Skirt/200849379-1-black.jfif"></td>
		      <td><p class="one">Miss Selfridge matching ribbed pencil skirt</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Miss Selfridge matching ribbed pencil skirt";
				 $price=3500;
				 $color="Black";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
