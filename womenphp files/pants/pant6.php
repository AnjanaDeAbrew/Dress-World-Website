...
</header><form action="pant6.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Pants/201102506-1-perfectblack.jfif"></td>
		      <td><p class="one">Weekday Body organic cotton blend skinny high waisted jeans in black</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 6400</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Perfect black</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Weekday Body organic cotton blend skinny high waisted jeans in black";
				 $price=6400;
				 $color="Perfect black";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
