...
</header><form action="pant4.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Pants/200844784-1-chocolategingham.jfif"></td>
		      <td><p class="one">Jersey tapered suit pants in chocolate gingham</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 3600</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Chocolate gingham</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Jersey tapered suit pants in chocolate gingham";
				 $price=3600;
