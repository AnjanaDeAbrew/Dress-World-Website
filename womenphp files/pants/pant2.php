...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Pants/200574186-1-khaki.jfif"></td>
		      <td><p class="one">Noughties low riding belted kickflare pant in khaki</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 4000</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Noughties low riding belted kickflare pant in khaki";
				 $price=4000;
				 $color="Khaki";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
