...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Pants/200849589-1-mocha.jfif"></td>
		      <td><p class="one">Miss Selfridge side split wide leg pant</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 3500</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Mocha</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Miss Selfridge side split wide leg pant";
				 $price=3500;
				 $color="Mocha";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
