...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Pants/24372739-1-washedgreyripped.jfif"></td>
		      <td><p class="one">Dr Denim Nora mom jeans with rips in washed gray</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 5000</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Washed gray ripped</p></td>
	        </tr>
		    <tr>								
...
<?php
			 ...
			 {
				 $proname="Dr Denim Nora mom jeans with rips in washed gray";
				 $price=5000;
				 $color="Washed gray ripped";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
