...
</header><form action="pant3.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Pants/200743456-1-petrolblue.webp"></td>
		      <td><p class="one">Tall legging with high waist in petrol blue</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 1400</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Petrol blue</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Tall legging with high waist in petrol blue";
				 $price=1400;
				 $color="Petrol blue";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
