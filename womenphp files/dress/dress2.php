...
</header><form action="dress2.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Dress/200574122-1-brown.jfif"></td>
		      <td><p class="one">Satin batwing bias cut maxi dress in chocolate</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 7000</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Brown</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Satin batwing bias cut maxi dress in chocolate";
				 $price=7000;
				 $color="Brown";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
