...
</header><form action="dress4.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Dress/200884505-1-rose.jfif"></td>
		      <td><p class="one">Maternity pleated twist back cap sleeve midi dress in rose</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 5500</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Rose</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Maternity pleated twist back cap sleeve midi dress in rose";
				 $price=5500;
				 $color="Rose";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
