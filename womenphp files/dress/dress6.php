...
</header><form action="dress6.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Dress/201604884-1-brown.jfif"></td>
		      <td><p class="one">Bershka knitted dress with high neck in brown</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 3500</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Bershka knitted dress with high neck in brown";
				 $price=3500;
				 $color="Brown";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
