...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
		<ul class="nav-area">
		<li><a href="../dress.php"><button class="btn2"><i class="fa fa-angle-left"></i> Previous </button></a></li>	
...
</header><form action="dress1.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Dress/24487573-1-whitebroderie.jfif"></td>
		      <td><p class="one">Fashion Union Exclusive cut out mini beach dress with puff sleeves in white eyelet</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 4200</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: White broderie</p></td>
	        </tr>
		    <tr>								
...
<?php
			 ...
			 {
				 $proname="Fashion Union Exclusive cut out mini beach dress with puff sleeves in white eyelet";
				 $price=4200;
				 $color="White broderie";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
