...
</header><form action="dress3.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Dress/200883788-1-red.jfif"></td>
		      <td><p class="one">Cami cowl neck midi dress in red</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 2000</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Red</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Cami cowl neck midi dress in red";
				 $price=2000;
				 $color="Red";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
