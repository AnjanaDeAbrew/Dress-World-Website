...
</header><form action="dress5.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Women/Dress/201309049-1-alyiafloral.jfif"></td>
		      <td><p class="one">Nobody's Child Alexa garden floral button detail midi dress in multi</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 4600</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Alyia Floral</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Nobody's Child Alexa garden floral button detail midi dress in multi";
				 $price=4600;
				 $color="Alyia Floral";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
