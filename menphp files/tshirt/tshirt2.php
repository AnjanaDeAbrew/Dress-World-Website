...
</header><form action="tshirt2.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/9398767-1-white.jfif"></td>
		      <td><p class="one">Tommy Hilfiger authentic lounge t-shirt side logo taping in white</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 1900</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: White</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Tommy Hilfiger authentic lounge t-shirt side logo taping in white";
				 $price=1900;
				 $color="White";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
