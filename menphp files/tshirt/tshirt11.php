...
</header><form action="tshirt11.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/24225526-1-caféaulait.jfif"></td>
		      <td><p class="one">Organic tank with extreme racer back in brown</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. Rs. 800</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Café au lait</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Organic tank with extreme racer back in brown";
				 $price=800;
				 $color="Café au lait";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
