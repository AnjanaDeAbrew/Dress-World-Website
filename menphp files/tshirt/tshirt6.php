...
</header><form action="tshirt6.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/24308026-1-green.jfif"></td>
		      <td><p class="one">Dickies Taylor back print T-shirt in military green</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 1200</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Green</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Dickies Taylor back print T-shirt in military green";
				 $price=1200;
				 $color="Green";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
