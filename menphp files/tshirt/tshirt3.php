...
</header><form action="tshirt3.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/22836348-1-khaki.jfif"></td>
		      <td><p class="one">COLLUSION organic cotton long sleeve t-shirt in khaki</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 1000</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="COLLUSION organic cotton long sleeve t-shirt in khaki";
				 $price=1000;
				 $color="Khaki";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
