...
</header><form action="tshirt10.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/200249257-1-greymarl.jfif"></td>
		      <td><p class="one">The Couture Club circle signature t-shirt in gray heather</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 1750</p></p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Grey Heather</td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="The Couture Club circle signature t-shirt in gray heather";
				 $price=1750;
				 $color="Grey Heather";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
