...
</header><form action="tshirt9.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/200926977-1-black.jfif"></td>
		      <td><p class="one">DRESS WORLD DESIGN long sleeve roll neck in black</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="DRESS WORLD DESIGN long sleeve roll neck in blackte";
				 $price=1500;
				 $color="Black";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
