...
</header><form action="tshirt1.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/8403978-1-white.jfif"></td>
		      <td><p class="one">Polo Ralph Lauren slim fit t-shirt with crew neck in white</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 2900</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Grey Heather</p></td>
	        </tr>
		    <tr>								
...
<?php
			 ...
			 {
				 $proname="Polo Ralph Lauren slim fit t-shirt with crew neck in white";
				 $price=2900;
				 $color="Grey Heather";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
