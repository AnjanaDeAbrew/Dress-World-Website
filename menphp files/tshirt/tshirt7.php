...
</header><form action="tshirt7.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/24494517-1-burgundy.jfif"></td>
		      <td><p class="one">The North Face Red box t-shirt in burgundy Exclusive at DRESS WORLD</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 900</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Burgundy</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="The North Face Red box t-shirt in burgundy Exclusive at DRESS WORLD";
				 $price=900;
				 $color="Burgundy";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
