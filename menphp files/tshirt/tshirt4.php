...
</header><form action="tshirt4.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/23717684-1-blue.jfif"></td>
		      <td><p class="one">Nike Premium Essentials loose fit tie-dye t-shirt in blue</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Nike Premium Essentials loose fit tie-dye t-shirt in blue";
				 $price=1900;
				 $color="Blue";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
