...
</header><form action="tshirt12.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/200316568-1-ivory.jfif"></td>
		      <td><p class="one">COLLUSION Unisex oversized T-shirt with Grow print in ecru pique</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 2500</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Ivory</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="COLLUSION Unisex oversized T-shirt with Grow print in ecru pique";
				 $price=2500;
				 $color="Ivory";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
