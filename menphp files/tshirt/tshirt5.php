...
</header><form action="tshirt5.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/24237144-1-utilitybrown.jfif"></td>
		      <td><p class="one">The North Face Hit long sleeve t-shirt in brown</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 1500</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Utility brown</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="The North Face Hit long sleeve t-shirt in brown";
				 $price=1500;
				 $color="Utility brown";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
