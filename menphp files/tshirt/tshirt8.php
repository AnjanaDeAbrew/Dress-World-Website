...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
		<ul class="nav-area">
		<li><a href="../tshirt.php"><button class="btn2"><i class="fa fa-angle-left"></i> Previous </button></a></li>	
...
</header><form action="tshirt8.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/tshirts/200219218-1-canyonrose.jfif"></td>
		      <td><p class="one">DRESS WORLD DESIGN oversized T-shirt in red ribbed velour with Stockholm city embroidery</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 1950</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Canyon rose</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="DRESS WORLD DESIGN oversized T-shirt in red ribbed velour with Stockholm city embroidery";
				 $price=1950;
				 $color="Canyon rose";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
