...
</header><form action="shoe2.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/Shoes/23311324-1-white.jfif"></td>
		      <td><p class="one">Fred Perry B7259 kingston twill sneakers in white</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Fred Perry B7259 kingston twill sneakers in white";
				 $price=7000;
				 $color="White";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
