...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/Shoes/200456033-1-brown.jfif"></td>
		      <td><p class="one">Converse Chuck Taylor All Star Hi suede sneakers in cedar bark</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 6500</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Converse Chuck Taylor All Star Hi suede sneakers in cedar bark";
				 $price=6500;
				 $color="Brown";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
