...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/Shoes/200913851-1-black.jfif"></td>
		      <td><p class="one">Armani Exchange Osaka chunky sneakers in black</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 10000</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Armani Exchange Osaka chunky sneakers in black";
				 $price=10000;
				 $color="Black";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
