...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/Shoes/200525037-1-black.jfif"></td>
		      <td><p class="one">Converse Run Star Hike Hi canvas platform sneakers in black</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 9000</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Converse Run Star Hike Hi canvas platform sneakers in black";
				 $price=9000;
				 $color="Black";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
