...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/Shoes/21774728-1-brown.jfif"></td>
		      <td><p class="one">Oxford brogue shoes in brown leather</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 5600</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Oxford brogue shoes in brown leather";
				 $price=5600;
				 $color="Brown";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
