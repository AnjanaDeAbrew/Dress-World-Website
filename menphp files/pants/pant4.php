...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/pants/24071895-1-frenchroast.jfif"></td>
		      <td><p class="one">Skinny chinos with elasticated waist in brow</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 2300</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: French roast</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Skinny chinos with elasticated waist in brow";
				 $price=2300;
				 $color="French roast";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
