...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/pants/23500247-1-grey.jfif"></td>
		      <td><p class="one">Slim pants with elastic waist in brown check</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Slim pants with elastic waist in brown check";
				 $price=3000;
				 $color="Grey";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
