...
</header><form action="pant5.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/pants/200416833-1-stone.jfif"></td>
		      <td><p class="one">Skinny chinos with elasticated waist in stone</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Skinny chinos with elasticated waist in stone";
				 $price=2600;
				 $color="Stone";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
