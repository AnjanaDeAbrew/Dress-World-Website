...
<header><img src="../../Images/logo.png" alt="" class="logo">
	<nav>
	 ...
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/pants/23117349-1-grey.jfif"></td>
		      <td><p class="one">Slim chino shorts in light gray</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Slim chino shorts in light gray";
				 $price=1000;
				 $color="Grey";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
