...
</header><form action="shirt2.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/14508311-1-white.jfif"></td>
		      <td><p class="one">DRESS WORLD DESIGN slim fit oxford shirt in white</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="DRESS WORLD DESIGN slim fit oxford shirt in white";
				 $price=2300;
				 $color="White";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
