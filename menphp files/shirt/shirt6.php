...
</header><form action="shirt6.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/24063542-1-grey.jfif"></td>
		      <td><p class="one">DRESS WORLD DESIGN stretch slim shirt in gray</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 2600</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Grey</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="DRESS WORLD DESIGN stretch slim shirt in gray";
				 $price=2600;
				 $color="Grey";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
