...
</header><form action="shirt10.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/200560997-1-black.jfif"></td>
		      <td><p class="one">New Look long sleeve organic cotton oxford shirt in black</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="New Look long sleeve organic cotton oxford shirt in black";
				 $price=3000;
				 $color="Black";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
