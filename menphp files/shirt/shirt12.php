...
</header><form action="shirt12.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/8403969-1-blue.jfif"></td>
		      <td><p class="one">Polo Ralph Lauren oxford shirt in slim fit blue</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Polo Ralph Lauren oxford shirt in slim fit blue";
				 $price=2900;
				 $color="Blue";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
