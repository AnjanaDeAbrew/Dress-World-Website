...
</header><form action="shirt7.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/24522911-1-black.jfif"></td>
		      <td><p class="one">Stripe shirt in black</p></td>
	        </tr>
		    <tr>
