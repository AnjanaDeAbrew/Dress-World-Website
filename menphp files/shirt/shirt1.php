...
</header><form action="shirt1.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/8404176-1-white.jfif"></td>
		      <td><p class="one">Polo Ralph Lauren oxford shirt in slim fit white</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Polo Ralph Lauren oxford shirt in slim fit white";
				 $price=2400;
				 $color="White";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
