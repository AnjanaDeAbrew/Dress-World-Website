...
</header><form action="shirt5.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/23632998-1-blue.jfif"></td>
		      <td><p class="one">DRESS WORLD DESIGN stretch slim fit work shirt in blue</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="DRESS WORLD DESIGN stretch slim fit work shirt in blue";
				 $price=2400;
				 $color="Blue";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
