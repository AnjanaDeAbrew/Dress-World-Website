...
</header><form action="shirt4.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/23405763-1-blue.jfif"></td>
		      <td><p class="one">River Island short sleeve linen shirt in blue</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 1800</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="River Island short sleeve linen shirt in blue";
				 $price=1800;
				 $color="Blue";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
