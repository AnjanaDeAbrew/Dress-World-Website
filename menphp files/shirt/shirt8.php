...
</header><form action="shirt8.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/200250133-1-burgundy.jfif"></td>
		      <td><p class="one">Revere shirt in burgundy and white scribble floral</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="Revere shirt in burgundy and white scribble floral";
				 $price=2900;
				 $color="Burgundy";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
