...
</header><form action="shirt11.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/200931442-1-mustard.jfif"></td>
		      <td><p class="one">90s oversized cord shirt in mustard</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 3400</p></td>
	        </tr>
		    <tr>
		      <td><p class="three">COLOR: Mustard</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="90s oversized cord shirt in mustard";
				 $price=3400;
				 $color="Mustard";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
