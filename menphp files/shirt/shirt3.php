...
</header><form action="shirt3.php" method="post" enctype="multipart/form-data">
	 <table width="675" height="507" border="0">
		  <tbody>
		    <tr>
		      <td rowspan="6"><img src="../../Images/Men/shirts/22326683-1-white.jfif"></td>
		      <td><p class="one">DRESS WORLD DESIGN skinny fit shirt with band collar in white</p></td>
	        </tr>
		    <tr>
		      <td><p class="two">Rs. 2600</p></td>
	        </tr>
		    <tr>
...
<?php
			 ...
			 {
				 $proname="DRESS WORLD DESIGN skinny fit shirt with band collar in white";
				 $price=2600;
				 $color="White";
				 $select=$_POST["select"];
				 $count=$_POST["number"];	 
