...
<title>MEN FASHION</title>
	<link rel="stylesheet" type="text/css" href="CSS/MenStyle.css">
...
<body>
	...
	<nav>
		...
		<div class="container1">		
			 <img src="Images/mensfashion.png">
		</div><br><br>
	<div class="container2"><p>CATEGORIES</p>
		</div><br><br>
<div class="container3">		
		  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href="menphp files/tshirt.php"><img src="Images/Men/mantshirt.PNG"></a>
		   <a href="menphp files/shirt.php"><img src="Images/Men/shirt.PNG"></a>
		   <a href="menphp files/pants.php"><img src="Images/Men/pants.PNG"></a>
		   <a href="menphp files/shoe.php"><img src="Images/Men/shoes.PNG"></a>
